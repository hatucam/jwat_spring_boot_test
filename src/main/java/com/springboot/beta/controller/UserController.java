package com.springboot.beta.controller;

import com.springboot.beta.entity.User;
import com.springboot.beta.model.UserNameProfile;
import com.springboot.beta.service.UserService;
...
public class UserController {
    ...
    @ApiOperation(value = "Đăng xuất - Get token logout")
    @PostMapping("/logout")
    public ResponseEntity<?> logoutUser(@Valid @RequestBody HashMap<String, String> request){
        return ResponseEntity.ok(userService.logoutUser(request.get("logout")));
    }
