...
public class BookService {
    ...
    public ResponseData<Booking> bookTicket(Authentication authentication, BookRequest bookRequest){
        ...
        if(bookRequest == null){
            ...
            return new ResponseData(HttpStatus.OK, "success", bookRepository.bookTicket(userId, bookRequest.getPrice()));
        }
    }
