...
import com.springboot.beta.config.JwtToken;
...
public class UserService {
    ...
    public ResponseData<Integer> registerUser(User user){
        ...
        if(user.getUserGender() == 1){
            avt = "http://laspringboot.tk/src/beta/img/trai.jpg";
        }else{
            avt = "http://laspringboot.tk/src/beta/img/gai.jpg";
        }
    ...
    public Object logoutUser(String string) {
        return null;
    }
}
